...
public class user1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("NO.OF PART TIME_DAYS");
        ...
        jLabel6.setText("Rs.REDUCED FOR LEAVE_DAYS");

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel7.setText("Rs.ADDED FOR PART TIME_DAYS");
    ...
    int a=Integer.parseInt(s1);
     ...
     String u;
        try{
            ...
            ResultSet rs=st.executeQuery("select empname,leave_days,parttime_days,salary,empid from payroll");
            while(rs.next()){
              i=rs.getInt(5);
               l=rs.getInt(2);
               p=rs.getInt(3);
               ...
               if(i==a)
               {
                  ...
                  String j=String.valueOf(leave);
                   jTextField3.setText(j);
                    String k=String.valueOf(parttime);
