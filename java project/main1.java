...
public class main1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            model.setRowCount(0);
            c=DriverManager.getConnection("jdbc:derby://localhost:1527/salary");
            ...
            while(rs.next())
            {
               ...
               String l=String.valueOf(rs.getInt("leave_days"));
               String p=String.valueOf(rs.getInt("parttime_days"));
               String s=String.valueOf(rs.getInt("salary"));
               String data[]={id,n,l,p,s};
               model.addRow(data);
            }
